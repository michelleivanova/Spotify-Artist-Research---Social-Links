"""
MusicBrainz Social Links Enrichment for Female Singers

Fills missing Instagram, Twitter, Facebook, and website URLs.
Run AFTER enrich_female_singers.py completes.

Usage:
    python enrich_musicbrainz_female_singers.py
    python enrich_musicbrainz_female_singers.py --resume-from 1000
"""
...
INPUT_CSV = "female_singers_enriched.csv"
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("enrich_musicbrainz_female_singers.log"),
    ],
)
