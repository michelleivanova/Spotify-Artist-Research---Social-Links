#!/usr/bin/env python3
"""
Create a multi-sheet Excel file for DJ Producers matching the format of female_singers_final.xlsx:
...
def main():
    # Read the DJProducers CSV file
    input_file = 'Soundcharts Pulled-Out Data/DJProducers.csv'
